...
class LivewireTest extends TestCase
{
    ...
    public function test_addnews_embargo_dhaka_to_utc(): void
    {
        ...
        $expected = Carbon::parse('2026-08-28T15:00', 'Asia/Dhaka')->utc()->toDateTimeString();
    ...
    {
        $this->actingAs($this->editor);
        $a1 = MediaAsset::create(['public_id' => (string) Str::ulid(), 'kind' => 'photo', 'status' => 'field', 'title' => 'Sunset photo', 'caption' => 'cap', 'credit_line' => 'UNB', 'mime' => 'image/jpeg', 'size_bytes' => 100, 'checksum' => hash('sha256', 'a'), 'storage_disk' => 's3', 'original_path' => 'a.jpg', 'uploaded_by' => $this->editor->id]);
        $a2 = MediaAsset::create(['public_id' => (string) Str::ulid(), 'kind' => 'photo', 'status' => 'library', 'title' => 'City library', 'caption' => 'cap', 'credit_line' => 'UNB', 'mime' => 'image/jpeg', 'size_bytes' => 100, 'checksum' => hash('sha256', 'b'), 'storage_disk' => 's3', 'original_path' => 'b.jpg', 'uploaded_by' => $this->editor->id]);
