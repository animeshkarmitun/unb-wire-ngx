      ...
      <div class="stepper" id="stepper">
        <button type="button" class="stp {{ $step === 1 ? 'active' : ($step > 1 ? 'done' : '') }}" wire:click="go(1)" data-go="1" aria-label="Step 1: Write" @if($step === 1) aria-current="step" @endif>
          <span class="stp-num"><span>1</span></span>
          <span class="stp-label">Write</span>
        </button>
        <span class="stp-line {{ $step > 1 ? 'done' : '' }}" data-line="1"></span>

        <button type="button" class="stp {{ $step === 2 ? 'active' : ($step > 2 ? 'done' : '') }}" wire:click="go(2)" data-go="2" aria-label="Step 2: Media" @if($step === 2) aria-current="step" @endif>
        ...
        <button type="button" class="stp {{ $step === 3 ? 'active' : ($step > 3 ? 'done' : '') }}" wire:click="go(3)" data-go="3" aria-label="Step 3: Organize and access" @if($step === 3) aria-current="step" @endif>
        ...
        <button type="button" class="stp {{ $step === 4 ? 'active' : '' }}" wire:click="go(4)" data-go="4" aria-label="Step 4: Review and publish" @if($step === 4) aria-current="step" @endif>
